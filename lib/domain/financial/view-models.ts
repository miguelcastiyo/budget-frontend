...
export function taxonomyFromState(state: RehydratedFinancialState) { return { tags: state.tags.filter((item) => !item.isDeleted).map((item) => ({ id: referenceTail(item.id), name: item.name, icon_key: item.iconKey })), contexts: state.contexts.filter((item) => !item.isDeleted).map((item) => ({ id: referenceTail(item.id), name: item.name, icon_key: item.iconKey })), cards: state.cards.filter((item) => !item.isDeleted).map((item) => ({ id: referenceTail(item.id), name: item.name, is_favorite: item.isFavorite })) } }
